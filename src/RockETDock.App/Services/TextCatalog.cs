...
public sealed class LocalizedText
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishValues = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["SettingsManageDocksTitle"] = "Manage docks",
        ["SettingsManageDocksSubtitle"] = "Choose which dock the tabs below should edit, or create a new dock on one screen edge.",
        ["SettingsDockLimitStatus"] = "{0} of {1} docks in use.",
        ["SettingsDockLimitReached"] = "Rock ET Dock supports up to 4 docks.",
        ["SettingsDragSectionTitle"] = "Drag and auto-hide",
        ["SettingsAppDisplayName"] = "App display name",
        ...
        ["SettingsDisableMinimizeAnimations"] = "Disable minimize animations",
        ["SettingsDisableMinimizeAnimationsTooltip"] = "Removes the native minimize and restore animation while Rock ET Dock is running.",
    ...
    private static readonly IReadOnlyDictionary<string, string> PortugueseBrazilianValues = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["SettingsManageDocksTitle"] = "Gerenciar barras",
        ["SettingsManageDocksSubtitle"] = "Escolha qual barra as abas abaixo devem editar ou crie uma nova barra em uma borda da tela.",
        ["SettingsDockLimitStatus"] = "{0} de {1} barras em uso.",
        ["SettingsDockLimitReached"] = "O Rock ET Dock suporta ate 4 barras.",
        ["SettingsDragSectionTitle"] = "Arrastar e auto-ocultar",
        ["SettingsAppDisplayName"] = "Nome do aplicativo",
        ...
        ["SettingsDisableMinimizeAnimations"] = "Desativar anima\u00e7\u00f5es de minimizar",
        ["SettingsDisableMinimizeAnimationsTooltip"] = "Remove a anima\u00e7\u00e3o nativa de minimizar e restaurar enquanto o Rock ET Dock estiver aberto.",
